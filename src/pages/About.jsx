...
function About() {
  ...
  return (
    <div className="h-auto w-full sm:mb-0">
      ...
      <div className="mx-auto flex w-[90%] flex-col justify-between rounded-lg bg-slate-50 p-4 shadow-lg md:flex-row md:items-center">
        ...
        <img
          className="max-w[500px] mt-4 bg-cover bg-center bg-no-repeat md:w-[350px] lg:mt-0 lg:h-[350px] lg:w-[350px]"
          src={AboutImage}
          alt=""
        />
      </div>
