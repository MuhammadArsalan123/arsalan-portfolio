...
import imagedeveloper from "../Assets/images/profile.png";
    ...
    <div className="h-auto w-full sm:mb-0 md:h-screen">
      <div className="mx-auto mt-40 flex w-[90%] flex-col items-center sm:flex-row lg:mt-32 lg:w-[90%] lg:justify-between  ">
        ...
        <div className="mt-20 lg:mt-12">
          <img
            className="max-w[550px] bg-cover bg-center rounded-full bg-no-repeat border-double border-4 border-black lg:h-[420px] lg:w-[600px]"
            src={imagedeveloper}
            alt=""
          />
        </div>
