...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-50 flex w-full items-center justify-between text-base transition-all sm:px-4 lg:px-16 lg:pt-2
      ${isScrolling ? "sticky" : ""}`}
    >
        ...
        <div className="cursor-pointer items-center space-x-4 sm:flex sm:flex-col sm:gap-4 lg:flex lg:flex-row lg:gap-6">
            ...
            <p
              className={
                activeSection === "Home-section"
                  ? "text-black border-b-2 pb-[4px] border-b-neutral-950"
          ...
          <div>
            <button
              ...
              className="button-UI w-[120px] rounded-lg px-4 py-1.5 font-bold tracking-wider text-black border-double border-4 border-black hover:text-black"
            >
              Resume
            </button>
          </div>
